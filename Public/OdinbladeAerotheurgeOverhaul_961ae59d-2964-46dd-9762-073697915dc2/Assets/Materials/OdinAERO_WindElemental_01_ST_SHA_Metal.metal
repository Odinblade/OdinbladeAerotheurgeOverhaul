...
vertex VertexOutput Materials_OdinAERO_WindElemental_01_ST_SHA_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput Materials_OdinAERO_WindElemental_01_ST_SHA_Metal_fragmentMain(VertexOutput In [[stage_in]])
{
	PixelOutput Out;
