...
vertex VertexOutput Materials_OdinAERO_WindElemental_01_ST_FOR_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
static void CalculateMatEmissiveColor(float2 in_0,
	thread float3& out_0,
	sampler _DefaultWrapSampler,
	texture2d<float> Texture2DParameter_62711617bb4f4109a3447db7a29566c0_DefaultWrapSampler)
{
...
static void CalculateMatNormal(float2 in_0,
	thread float3& out_0,
	sampler _DefaultWrapSampler,
	texture2d<float> Texture2DParameter_07a5c47d64ed4810a26fee8937c07755_DefaultWrapSampler)
{
...
static void CalculateMatBaseColor(float2 in_0,
	thread float3& out_0,
	sampler _DefaultWrapSampler,
	texture2d<float> Texture2DParameter_c8e6ee155d814e4a9e76a504b3e3c321_DefaultWrapSampler)
{
...
static void CalculateMatReflectance(float2 in_0,
	thread float& out_0,
	sampler _DefaultWrapSampler,
	texture2d<float> Texture2DParameter_b25ba794b41443f789da28f64f88b7c3_DefaultWrapSampler)
{
...
fragment PixelOutput Materials_OdinAERO_WindElemental_01_ST_FOR_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
	...
	IBL_PARAMS)
{
	...
	CalculateMatEmissiveColor(In.TexCoords0, matEmissiveColor, _DefaultWrapSampler, Texture2DParameter_62711617bb4f4109a3447db7a29566c0_DefaultWrapSampler);
	float3 matNormal;
	CalculateMatNormal(In.TexCoords0, matNormal, _DefaultWrapSampler, Texture2DParameter_07a5c47d64ed4810a26fee8937c07755_DefaultWrapSampler);
	//Normalize World Normal
	...
	float3 matBaseColor;
	CalculateMatBaseColor(In.TexCoords0, matBaseColor, _DefaultWrapSampler, Texture2DParameter_c8e6ee155d814e4a9e76a504b3e3c321_DefaultWrapSampler);
	float matReflectance;
	CalculateMatReflectance(In.TexCoords0, matReflectance, _DefaultWrapSampler, Texture2DParameter_b25ba794b41443f789da28f64f88b7c3_DefaultWrapSampler);
	...
	float3 iblDiffuse;
	float3 iblSpecular;
	EvaluateDistantIBL(matBaseColor, matRoughness, float3(matReflectance, matReflectance, matReflectance), 0.0f, matNormal, worldViewNormalized, iblDiffuse, iblSpecular, IBL_PARAMS_CONSTRUCT);
	FinalColor = ((FinalColor + iblDiffuse) + iblSpecular);

	float3 LightDiffuseColorOut;
	float3 LightSpecularColorOut;
	DirectionLight(matNormal, worldViewNormalized, perFrame.global_LightPropertyMatrix, matBaseColor, matReflectance, matRoughness, 0.0f, LightDiffuseColorOut, LightSpecularColorOut);
